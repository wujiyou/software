<template>
  <div>
    ...
    <el-table :data="tableData" class="table" :max-height="getHeight" empty-text="本来无一物，何处惹尘埃">
      <el-table-column fixed type="index" label="文章编号" width="180"></el-table-column>
...
<script>
  ...
  import {downExcelMoudle} from "../utils/api"
  ...
  export default {
    ...
    methods: {
      ...
      * */
      ...
      downTemplate() {
        downExcelMoudle( { responseType: "blob" }).then(res=>{
          console.log(res)
        })
        // this.$http
        //   .post(
